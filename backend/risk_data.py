...
PRS_GENES = dict(
    ...
    rs10202748=dict(risk_allele='A',  weight=0.652605, risk_ratio=-0.06,frequency=0.2704, gene_name='INPP5D'),
    ...
    rs1476679=dict(risk_allele='T',  weight=0.7885, risk_ratio=0.11,frequency=0.2115, gene_name='ZCWPW1'),
    rs78571833=dict(risk_allele='A',  weight=0.975, risk_ratio=0.14,frequency=0.025, gene_name='AL833583'),
    rs12679874=dict(risk_allele='A', weight=0.5445, risk_ratio=-0.09,frequency=0.4555, gene_name='PTK2B'),
    ...
    rs9331888=dict(risk_allele='C',  weight=0.6665, risk_ratio=0.16,frequency=0.3335, gene_name='CLU'),
    rs7920721=dict(risk_allele='A',  weight=0.7302, risk_ratio=-0.07,frequency=0.2698, gene_name='CR595071'),
    rs3740688=dict(risk_allele='T',  weight=0.6392, risk_ratio=0.07,frequency=0.3608, gene_name='SPI1'),
    ...
    rs11218343=dict(risk_allele='T', weight=0.891, risk_ratio=0.18,frequency=0.109, gene_name='SORL1'),
    rs6572869=dict(risk_allele='A',  weight=0.2754, risk_ratio=-0.11,frequency=0.2754, gene_name='FERMT2'),
    rs12590273=dict(risk_allele='T',  weight=0.9083, risk_ratio=0.1,frequency=0.0917, gene_name='SLC24A4'),
    rs7145100=dict(risk_allele='C',  weight=0.146, risk_ratio=0.08,frequency=0.146, gene_name='abParts'),
    rs74615166=dict(risk_allele='T',  weight=0.992612, risk_ratio=-0.23,frequency=0.0074, gene_name='TRIP4'),
    rs2526378=dict(risk_allele='A', weight=0.4722, risk_ratio=0.09,frequency=0.4722, gene_name='BZRAP1'),
    rs117481827=dict(risk_allele='T', weight=0.9531, risk_ratio=-0.09,frequency=0.0469, gene_name='C19orf6'),
    rs7408475=dict(risk_allele='C',  weight=0.7392, risk_ratio=0.18,frequency=0.2608, gene_name='ABCA7'),
